                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 text-xs font-medium text-teal-300 bg-teal-500/10 border border-teal-500/20 rounded-lg hover:bg-teal-500/20 transition-colors"
                    >
                      Setup Wizard
                    </button>
                  </div>
                  ...
                  {mcpInstances.length === 0 ? (
                    <div className="empty-state py-12 border border-dashed border-tsushin-border rounded-xl">
                      ...
                      <div className="flex items-center gap-3 justify-center">
                        ...
                        <button
                          onClick={() => setShowMcpCreateModal(true)}
                          className="px-4 py-2 bg-tsushin-deep border border-tsushin-border text-tsushin-slate hover:text-white rounded-lg text-sm transition-colors"
                        >
                          Manual Setup
                        </button>
                      </div>
