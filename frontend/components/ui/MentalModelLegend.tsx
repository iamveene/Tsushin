...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    description:
      'Connect AI providers, channels (WhatsApp / Slack / Discord / Email), triggers (Jira / GitHub / GitLab / Webhook), repository connections (GitHub / GitLab), tool APIs (1Password, Jira credentials, etc.), and self-hosted local services (Whisper / Ollama). Anything that lives outside Tsushin and your agents need to talk to lives here.',
    Icon: PlugIcon,
