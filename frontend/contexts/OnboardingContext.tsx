 ...
 * v0.7.0:    TOTAL_STEPS raised to 16 through Sentinel, voice, and trigger-readiness steps.
 */
...
// v0.7.0 (Triggers + Continuous Agents): Raised to 16 — added a read-only control-plane readiness step.
