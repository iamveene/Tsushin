...
- Added 20 unit tests for the compiler (Correios-shaped event sequences, selector strategy ladder, password detection, captcha `value_target` wiring, `pvh_`/`op://` vault round-trips, click-before-fill dedupe).
