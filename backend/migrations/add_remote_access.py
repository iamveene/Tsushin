"""v0.6.0 Remote Access migration (SQLite/non-Alembic fallback).
            ...
            if "remote_access_config" not in inspector.get_table_names():
                conn.execute(text("""
                    CREATE TABLE remote_access_config (
                        ...
                        target_url VARCHAR(255) NOT NULL DEFAULT 'http://frontend:3030',
                ...
                conn.execute(text(
                    ...
                    "VALUES (1, 0, 'quick', 0, 'auto', 'http://frontend:3030')"
                ))
