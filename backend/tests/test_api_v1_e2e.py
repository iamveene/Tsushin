...
class TestAgentDescription:
    ...
    def test_list_agents_shows_description(self, api_headers):
        ...
        # List and find our agent (use per_page=100 to ensure newly created agent is included)
        list_resp = requests.get(f"{API_URL}/api/v1/agents?per_page=100", headers=api_headers)
