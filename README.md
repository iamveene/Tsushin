...
- **Unified Trigger Creation Wizard + Visual Schedule Picker** — one wizard creates Email, Webhook, Jira, GitHub, and GitLab triggers, selects or creates the required Hub integration, and hands off to the generated or wired flow at `/flows?edit=<auto_flow_id>` so operators configure outputs in the Flow editor.
